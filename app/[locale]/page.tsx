  ...
  const testimonials = [
    {
      ...
      quote: 'Amazing platform that transformed our business processes.',
    },
  ];

  const brands = [{ id: 1, name: 'Brand 1', logo: '/brands/1.svg' }];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-8">{t('about.description')}</p>
